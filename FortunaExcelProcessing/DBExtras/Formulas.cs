...
namespace FortunaExcelProcessing.DBExtras
{
    public static class Formulas
    {
        ...
        public static Dictionary<int, string> formulae = new Dictionary<int, string>() {
            ...
            //need 55 and 62 needs fixing || 56,58,61 need to be stored and pulled from db
            //{56, "IF({0}56=\"\",\"\",IF(OFFSET({0}57,0,-1)=\"\",{0}56,{0}56+OFFSET({0}57,0,-1)))"},
            //{58, "IF({0}58=\"\",\"\",IF(OFFSET({0}59,0,-1)=\"\",{0}58,{0}58+OFFSET({0}59,0,-1)))" },
            {59, "{0}59/{0}15" },
