...
namespace FortunaExcelProcessing.WeeklyProcessing
{
    class EditWeeklyDataTable : ITableEditor
    {
        ...
        ISheet _sheet;
        private int[] dataRows = { 6, 7, 8, 10, 11, 13, 14, 16, 18, 19, 21, 22, 24, 28, 32, 33, 34, 35, 37, 38, 39, 40, 41, 42, 43, 44, 45, 50, 51, 54, 56, 100, 101, 102, 103, 104, 105, 106, 108, 109, 110, 111, 112, 113, 114};
